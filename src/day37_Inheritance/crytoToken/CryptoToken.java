package day37_Inheritance.crytoToken;

public class CryptoToken {//Parent
...
methods:
setInfo() toString() totalPrice(): returns the total price of the cyrpto totek ( price * quantity)
